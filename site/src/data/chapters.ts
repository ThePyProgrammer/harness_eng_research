...
const curatedChapters: CuratedChapterSeed[] = [
  ...
  },
  {
    ...
    sections: {
      ...
      interpretation: 'Temporal design is where the book stops flattering fast demos. If the result is stale, speculative, cached past its evidence horizon, or unchecked, the apparent acceleration does not count as verified research progress.',
