...
\title{Coordination Architecture for Multi-Agent Software Engineering:\\
  Error Amplification, Task Decomposition, and Quality-Adjusted Speedup}

\author{
  Theory and Position Paper\\[6pt]
  \textit{Synthesized from distributed systems theory, graph partitioning,}\\
  \textit{concurrency control, and empirical multi-agent scaling data}
}
